      ...
      const handleSubmit= async(e)=>{
        ...
        try {
          ...
          if(response.status == 200){
           ...
           console.log("error occured in stepform profile :",error.message)
        }
  ...
  return (
    <div className='stepnew-main'>
        <div className='lefthalf'>
            ...
            <img className='left-imge' src={getImageSource(page)}/>
        </div>
        <div className='righthalf'>
        {page===0? <Form onSubmit={handleSubmit}>
             <Row>
                  <Col>
                       <FloatingLabel
                ...
                <Form.Label className="color-text " >Industry</Form.Label>
                  <Form.Select
                     onChange={handleOnChange} name='industry' value={formData.industry || 'Please Select'} required
